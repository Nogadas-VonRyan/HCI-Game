...
func _on_slot1_input(_camera, _event, _position, _normal, _shape_idx):
	rotateSlot(0)

func _on_slot2_input(_camera, _event, _position, _normal, _shape_idx):
	rotateSlot(1)

func _on_slot3_input(_camera, _event, _position, _normal, _shape_idx):
	rotateSlot(2)

func _on_slot4_input(_camera, _event, _position, _normal, _shape_idx):
	rotateSlot(3)

func _on_slot5_input(_camera, _event, _position, _normal, _shape_idx):
	rotateSlot(4)
